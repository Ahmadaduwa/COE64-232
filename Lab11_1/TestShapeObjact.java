...
public class TestShapeObjact {
    ...
    public static void displayAllShape(ArrayList<Shape> o){
        ...
        for(int i=0; i<o.size(); i++){
            if(o.get(i).getClass().getName().equals("Lab11_1.Rectangle")){
        ...
        for(int i=0; i<o.size(); i++){
            if(o.get(i).getClass().getName().equals("Lab11_1.Trinangle")){
                System.out.println("1. "+o.get(i).toString());
                System.out.println("Area: "+o.get(i).getArea()+" Perimeter: "+o.get(i).getPerimeter());
            }
        }
        ...
        System.out.println("Rectangle: "+o.get(max[0]).getPerimeter()+ " of No. "+max[0]);
        System.out.println("Triangle: "+o.get(max[1]).getPerimeter()+ " of No. "+max[1]);

        int[] min = new int[2];
        min = findMin(o);
        System.out.println("Min Perimeter");
        System.out.println("Rectangle: "+o.get(min[0]).getPerimeter()+ " of No. "+min[0]);
        System.out.println("Triangle: "+o.get(min[1]).getPerimeter()+ " of No. "+min[1]);
    }
